...
```mermaid
graph LR
 A["Dòng Suy Nghĩ Tiêu Cực (Bên kia sông)"] <--> B["NGƯỜI QUAN SÁT TỈNH THỨC (Bạn ở bên này)"]
```
...
Bí kíp: Giữ nét mặt và ngưng lại 3 giâytrước khi phản ứng với bất kỳ sự cố nào.
